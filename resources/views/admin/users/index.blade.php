...
<script>
    $(document).ready(function() {
                ...
                success: function(response) {
                    ...
                    $.each(response.user, function(key,item){
                        $('#user').append('<tr>\
                                            ...
                                            <button type="button"class="view_user btn btn-info btn-sm"  value="' +item.id + '" id="delete" >view</button>\
                                        </td>\
                                            <tr>');  
                    })
        ...
        $(document).on('click', '.delete_user', function(e) {
                    ...
                    var url = "{{route('api.user.delete','') }}"+ '/' + user_id;
                    // alert (url);
                ...
                $(document).on('click', '.edit_user', function(e) {
                    ...
                    var url = "{{route('user.edit','') }}"+ '/' + user_id;
                    // alert (url);
